...
//        decoded by JFANNON 4-1-2020
//        public static byte[] mds_create_resp_msg = {
//        //SPpdu
//        0xE1, 0x00, //session id
//        0x00, 0x02, //context id
//        //ROapdus
//        0x00, 0x02, //ro_type, RORS_APDU
//        0x00, 0x14, //length
//        //RORSapdu
//        0x00, 0x01, //invoke_id
//        0x00, 0x01, //command type, CMD_CONFIRMED_EVENT_REPORT
//        0x00, 0x0E, //length
//        //EventReportRes.
//        //ManagedObjectId
//        0x00, 0x21, //m_obj_class, NOM_MOC_VMS_MDS
//        0x00, 0x00, //contect_id
//        0x00, 0x00, //handle
//        0x00, 0x0A, 0xBD, 0x00, //event_time
//        0x0D, 0x06, //event_type, NOM_NOTI_MDS_CREAT
//        0x00, 0x00//length
//        };
        public static byte[] mds_create_resp_msg = {
...
//            0x00, 0x00, //handle
//            0x00, 0x00, 0x00, 0x00, //scope
//            0xF1, 0x3B, //action_type, NOM_ACT_POLL_MDIB_DATA_EXT
//            0x00, 0x14, //length
//            //pollmdibdatareqext
//            0x00, 0x01, //poll_number
//            0x00, 0x01, //partition, NOM_PART_OBJ
//            0x00, 0x06, //code, NOM_MOC_VMO_METRIC_NU
//            0x00, 0x00, //polled_attr_grp, all attribute groups
//            //attributelist
//            0x00, 0x01, //count
//            0x00, 0x08, //length
//            //avatype
//            0xF1, 0x3E, //attribute_id, NOM_ATTR_TIME_PD_POLL
//            0x00, 0x04, //length
//            0x00, 0x03, 0xA9, 0x80//attribute_val, format:RelativeTime, value:240000 or (240000/8)/1000 = 30seconds
//        };
        public static byte[] ext_poll_request_msg5 =
        {
...
/*
        public static byte[] ext_poll_request_wave_msg =
		{
            ...
            0x00, 0x28, //length
            0x00, 0x04, //invoke 
            0x00, 0x07, //comnmand type 
            0x00, 0x22, //length 
            0x00, 0x21, //m_obj)class
			0x00, 0x00, //context 
            0x00, 0x00, //handle 
            0x00, 0x00, 0x00, 0x00, //scope
            0xf1, 0x3b, //action type
            0x00, 0x14, //length
            0x00, 0x03, //poll number
            0x00, 0x01, //partition
			0x00, 0x09, //code
            0x00, 0x00, //group
            0x00, 0x01, //count
            ...
            0xf1, 0x3e, //id
            0x00, 0x04, //length
            0x00, 0x49, 0x3e, 0x00 //value 4800000 = 600000ms  = 600s = 10 min
		};
*/
        public static byte[] ext_poll_request_wave_msg =
		{
        ...
        //JFANNON 4-1-2020
        public static byte[] ext_poll_request_pt_id =
        {
            //SPpdu
            0xE1, 0x00, //session id
            0x00, 0x02, //context id
            ...
            0x00, 0x00, //handle
            0x00, 0x00, 0x00, 0x00, //scope
            0x0C, 0x16, //action_type, NOM_ACT_POLL_MDIB_DATA
            0x00, 0x08, //length
            //pollmdibdatareqext
            0x00, 0x01, //poll_number
            0x00, 0x01, //partition, NOM_PART_OBJ
            0x00, 0x2A, //code, NOM_MOC_PT_DEMOG
            0x08, 0x07, //polled_attr_grp, NOM_ATTR_GRP_PT_DEMOG
        };
